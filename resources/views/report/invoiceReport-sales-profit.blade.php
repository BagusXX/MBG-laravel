        ...
        <table class="layout-table" style="border-bottom: 3px double #000; margin-bottom: 20px;">
            <tr>
                ...
                <td style="width: 60%; text-align: center; vertical-align: middle;">
                    ...
                    <h2 style="margin: 0; text-transform: uppercase;">{{ $submission->kitchen->nama ?? 'NAMA DAPUR' }}
                    </h2>
                    {{-- <h2 style="margin: 0; text-transform: uppercase;">Supplier : {{ $submission->supplier->nama ??
                        'NAMA SUPPLIER' }}</h2> --}}
